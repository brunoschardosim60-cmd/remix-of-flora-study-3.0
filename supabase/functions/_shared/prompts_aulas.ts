...
3. CHECKPOINTS: Após cada bloco, faça uma pergunta rápida de reflexão ou um mini-exercício.
...
export function buildLessonPrompt(content: string, materia: string, tema: string): string {
