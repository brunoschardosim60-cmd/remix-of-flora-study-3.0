  ...
  return (
    <div className="min-h-dvh bg-background">
      <div className="border-b border-border bg-card sticky top-0 z-10">
        <div className="container max-w-[1800px] mx-auto px-3 sm:px-4 py-3 flex items-center gap-3">
      ...
      <div className="container max-w-[1800px] mx-auto px-3 sm:px-4 py-6 space-y-4">
