                          ...
                          {isEditing ? (
                            ...
                            <div
                              ...
                              className={`p-2 rounded-lg cursor-pointer min-h-[52px] flex flex-col gap-1 relative group outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-1 focus-visible:ring-offset-background
                                ${displaySlot.materia
                                  ? `${SUBJECT_COLORS[displaySlot.materia]} bg-opacity-15 cursor-grab active:cursor-grabbing ${displaySlot.concluido ? "ring-1 ring-secondary/25" : ""}`
                              ...
                              {slot.materia && !isPreview && (
                                <div className="absolute top-0.5 right-0.5 flex gap-0.5 transition-all z-10">
                                  <button
                                    ...
                                    className={`h-4 w-4 rounded-full inline-flex items-center justify-center transition-colors ${slot.concluido ? "bg-secondary/40 text-secondary-foreground/80" : "bg-background/70 text-muted-foreground border border-border hover:text-foreground hover:border-foreground/60"}`}
                                ...
                                <>
                                  <div className="flex items-center gap-1">
                                    ...
                                    {displaySlot.concluido && (
                                      <Check className="w-2.5 h-2.5 text-secondary/60 flex-shrink-0" strokeWidth={2} />
                                    )}
                                  </div>
