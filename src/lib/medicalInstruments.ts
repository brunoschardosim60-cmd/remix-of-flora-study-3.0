...
export const medicalInstruments: MedicalInstrument[] = [
  ...
  {
    id: "penlight", name: "Lanterna clínica", aliases: ["penlight"], category: "Avaliação", level: "Iniciante", icon: "flashlight", image: "/medicine/instruments/penlight-v1.png",
  ...
  {
    id: "dermatoscope", name: "Dermatoscópio", aliases: ["dermoscópio"], category: "Avaliação", level: "Ciclo clínico", icon: "scan", image: "/medicine/instruments/dermatoscope-v1.png",
  ...
  {
    id: "measuring-tape", name: "Fita antropométrica", aliases: ["fita métrica clínica"], category: "Avaliação", level: "Iniciante", icon: "ruler", image: "/medicine/instruments/measuring-tape-v1.png",
  ...
  {
    id: "goniometer", name: "Goniômetro", aliases: ["medidor de ângulo articular"], category: "Avaliação", level: "Ciclo básico", icon: "ruler", image: "/medicine/instruments/goniometer-v1.png",
  ...
  {
    id: "hypodermic-needle", name: "Agulha hipodérmica", aliases: ["agulha descartável"], category: "Procedimentos", level: "Ciclo básico", icon: "syringe", image: "/medicine/instruments/hypodermic-needle-v1.png",
  ...
  {
    id: "mayo-scissors", name: "Tesoura Mayo", aliases: ["Mayo reta", "Mayo curva"], category: "Procedimentos", level: "Ciclo clínico", icon: "scissors", image: "/medicine/instruments/mayo-scissors-v1.png",
  ...
  {
    id: "metzenbaum-scissors", name: "Tesoura Metzenbaum", aliases: ["Metzenbaum"], category: "Procedimentos", level: "Internato", icon: "scissors", image: "/medicine/instruments/metzenbaum-scissors-v1.png",
  ...
  {
    id: "kelly-forceps", name: "Pinça hemostática Kelly", aliases: ["Kelly"], category: "Procedimentos", level: "Ciclo clínico", icon: "tool", image: "/medicine/instruments/kelly-forceps-v1.png",
  ...
  {
    id: "adson-forceps", name: "Pinça Adson", aliases: ["pinça de dissecção Adson"], category: "Procedimentos", level: "Ciclo clínico", icon: "tool", image: "/medicine/instruments/adson-forceps-v1.png",
  ...
  {
    id: "needle-holder", name: "Porta-agulhas Mayo-Hegar", aliases: ["porta-agulha"], category: "Procedimentos", level: "Ciclo clínico", icon: "tool", image: "/medicine/instruments/needle-holder-v1.png",
  ...
  {
    id: "tourniquet", name: "Torniquete", aliases: ["torniquete de extremidade"], category: "Procedimentos", level: "Internato", icon: "activity", image: "/medicine/instruments/tourniquet-v1.png",
  ...
  {
    id: "urinary-catheter", name: "Cateter urinário Foley", aliases: ["sonda vesical de demora", "Foley"], category: "Procedimentos", level: "Ciclo clínico", icon: "droplet", image: "/medicine/instruments/urinary-catheter-v1.png",
  ...
  {
    id: "oropharyngeal-airway", name: "Cânula orofaríngea", aliases: ["Guedel"], category: "Emergência", level: "Ciclo clínico", icon: "wind", image: "/medicine/instruments/oropharyngeal-airway-v1.png",
  ...
  {
    id: "laryngoscope", name: "Laringoscópio", aliases: ["laringoscópio direto"], category: "Emergência", level: "Internato", icon: "flashlight", image: "/medicine/instruments/laryngoscope-v1.png",
  ...
  {
    id: "endotracheal-tube", name: "Tubo endotraqueal", aliases: ["TOT", "tubo orotraqueal"], category: "Emergência", level: "Internato", icon: "wind", image: "/medicine/instruments/endotracheal-tube-v1.png",
  ...
  {
    id: "supraglottic-airway", name: "Dispositivo supraglótico", aliases: ["máscara laríngea"], category: "Emergência", level: "Internato", icon: "wind", image: "/medicine/instruments/supraglottic-airway-v1.png",
  ...
  {
    id: "aed", name: "Desfibrilador externo automático", aliases: ["DEA", "AED"], category: "Emergência", level: "Iniciante", icon: "zap", image: "/medicine/instruments/aed-v1.png",
  ...
  {
    id: "suction-catheter", name: "Cateter de aspiração", aliases: ["sonda de aspiração"], category: "Emergência", level: "Ciclo clínico", icon: "wind", image: "/medicine/instruments/suction-catheter-v1.png",
  ...
  {
    id: "cervical-collar", name: "Colar cervical", aliases: ["colar de imobilização"], category: "Emergência", level: "Ciclo básico", icon: "bone", image: "/medicine/instruments/cervical-collar-v1.png",
  ...
  {
    id: "glucometer", name: "Glicosímetro", aliases: ["medidor de glicemia"], category: "Diagnóstico", level: "Iniciante", icon: "droplet", image: "/medicine/instruments/glucometer-v1.png",
  ...
  {
    id: "ecg", name: "Eletrocardiógrafo", aliases: ["ECG", "aparelho de eletrocardiograma"], category: "Diagnóstico", level: "Ciclo básico", icon: "heart", image: "/medicine/instruments/ecg-v1.png",
  ...
  {
    id: "ultrasound-probe", name: "Transdutor de ultrassom", aliases: ["probe", "sonda de ultrassom"], category: "Diagnóstico", level: "Ciclo clínico", icon: "scan", image: "/medicine/instruments/ultrasound-probe-v1.png",
  ...
  {
    id: "centrifuge", name: "Centrífuga laboratorial", aliases: ["centrífuga"], category: "Diagnóstico", level: "Ciclo básico", icon: "activity", image: "/medicine/instruments/centrifuge-v1.png",
  ...
  {
    id: "micropipette", name: "Micropipeta", aliases: ["pipeta automática"], category: "Diagnóstico", level: "Ciclo básico", icon: "pipette", image: "/medicine/instruments/micropipette-v1.png",
  ...
  {
    id: "test-tube", name: "Tubo de coleta", aliases: ["tubo de ensaio", "tubo a vácuo"], category: "Diagnóstico", level: "Iniciante", icon: "test", image: "/medicine/instruments/test-tube-v1.png",
  ...
  {
    id: "peak-flow-meter", name: "Medidor de pico de fluxo", aliases: ["peak flow"], category: "Diagnóstico", level: "Ciclo básico", icon: "wind", image: "/medicine/instruments/peak-flow-meter-v1.png",
