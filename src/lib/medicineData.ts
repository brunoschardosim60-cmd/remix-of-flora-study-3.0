...
export const medicalSources: Record<string, MedicalSource> = {
  ...
  openstaxReproductive: {
    title: "The Reproductive System — Chapter Review",
    organization: "OpenStax, Rice University",
  ...
  openstaxMiddleAdult: {
    title: "Physical Development in Middle Adulthood",
    organization: "OpenStax, Rice University",
  ...
  openstaxLateAdult: {
    title: "Physical Aging in Late Adulthood",
    organization: "OpenStax, Rice University",
  ...
  openstaxInterview: {
    title: "Data Collection and Documentation — Complete Health History",
    organization: "OpenStax, Rice University",
  ...
  openstaxPhysicalAssessment: {
    title: "Physical Assessment — Clinical Nursing Skills",
    organization: "OpenStax, Rice University",
  ...
  ncbiMedicalInterview: {
    title: "The Medical Interview",
    organization: "NCBI Bookshelf / Butterworths",
    url: "https://www.ncbi.nlm.nih.gov/books/NBK349/",
    reviewedAt: "2026-08-25",
  },
  ncbiChestExam: {
    title: "The Chest Examination",
    organization: "NCBI Bookshelf / Butterworths",
    url: "https://www.ncbi.nlm.nih.gov/books/NBK368/",
    reviewedAt: "2026-08-25",
  },
  ncbiDataAnalysis: {
    title: "Collecting and Analyzing Data: Doing and Thinking",
    organization: "NCBI Bookshelf / Butterworths",
