...
export interface MedicalSystem {
  ...
  sourceId: string;
  referenceImages?: MedicalReferenceImage[];
}

export interface MedicalReferenceImage {
  image: string;
  alt: string;
  title: string;
  caption: string;
...
export interface DevelopmentStage {
  ...
  image: string;
  imageAlt: string;
  referenceImage?: MedicalReferenceImage;
}
...
export const medicalSources: Record<string, MedicalSource> = {
  ...
  servierMedicalArt: {
    title: "Servier Medical Art — pranchas médicas editáveis",
    organization: "Les Laboratoires Servier",
    url: "https://smart.servier.com/image-kits-by-category/",
    reviewedAt: "2026-08-30",
    license: "CC BY 4.0",
  ...
  nihHraBrain3D: {
    title: "3D Reference Organ for Brain, Female v1.3",
    organization: "Human Reference Atlas / NIH 3D",
    url: "https://3d.nih.gov/entries/3DPX-020959",
    reviewedAt: "2026-08-28",
    license: "CC BY 4.0",
    attribution: "Kristen Browne; Heidi Schlehlein. 2023. 3D Reference Organ for Brain, Female v1.3. https://doi.org/10.48539/HBM425.NDKM.969.",
  },
  nihHraLung3D: {
    title: "3D Reference Organ for Lung, Female v1.3",
    organization: "Human Reference Atlas / NIH 3D",
    url: "https://3d.nih.gov/entries/3DPX-020974",
    reviewedAt: "2026-08-28",
    license: "CC BY 4.0",
    attribution: "Kristen Browne; Heidi Schlehlein. 2023. 3D Reference Organ for Lung, Female v1.3. https://doi.org/10.48539/HBM794.PKQV.978.",
  },
  nihHraLiver3D: {
    ...
    reviewedAt: "2026-08-28",
    license: "CC BY 4.0",
    attribution: "Kristen Browne. 2021. 3D Reference Organ for Liver, Female v1.1. https://doi.org/10.48539/HBM798.JZZM.649.",
  },
  nihHraKidney3D: {
    title: "3D Reference Organs for Kidney, Female, Left and Right v1.2",
    organization: "Human Reference Atlas / NIH 3D",
    url: "https://3d.nih.gov/entries/3DPX-020967",
    reviewedAt: "2026-08-28",
    license: "CC BY 4.0",
...
export const medicalSystems: MedicalSystem[] = [
  { id: "cardiovascular", name: "Cardiovascular", description: "Bomba cardíaca, vasos e transporte sistêmico.", color: "#b35f68", icon: "heart", image: "/medicine/systems/cardiovascular-v1.png", structures: ["Coração", "Aorta", "Artérias", "Veias", "Capilares"], topics: ["Ciclo cardíaco", "Hemodinâmica", "Circulações pulmonar e sistêmica"], atlasStructureIds: ["heart", "right-atrium", "left-atrium", "right-ventricle", "left-ventricle", "tricuspid-valve", "mitral-valve", "aortic-valve", "pulmonary-trunk", "pulmonary-veins", "left-coronary-artery", "aorta", "aortic-arch", "superior-vena-cava", "femoral-artery"], questionSystems: ["Cardiovascular"], sourceId: "openstaxHeart", referenceImages: [{ image: "/medicine/references/servier/cardiovascular-valves.png", alt: "Vista superior das quatro válvulas cardíacas", title: "Válvulas cardíacas", caption: "Prancha complementar para comparar as válvulas atrioventriculares e semilunares.", sourceId: "servierMedicalArt" }] },
  { id: "respiratory", name: "Respiratório", description: "Ventilação, difusão e transporte de gases.", color: "#7398a8", icon: "lungs", image: "/medicine/systems/respiratory-v1.png", structures: ["Pulmões", "Traqueia", "Brônquios", "Alvéolos", "Diafragma"], topics: ["Mecânica ventilatória", "Trocas gasosas", "Controle da respiração"], atlasStructureIds: ["lungs", "nasal-cavity", "pharynx", "larynx", "epiglottis", "trachea", "main-bronchi", "bronchioles", "alveoli", "pleura", "diaphragm"], questionSystems: ["Respiratório"], sourceId: "openstaxRespiratory", referenceImages: [{ image: "/medicine/references/servier/respiratory-pulmonary-circulation.png", alt: "Circulação pulmonar entre coração e pulmões", title: "Circulação pulmonar", caption: "Relação visual entre coração, vasos pulmonares e parênquima pulmonar.", sourceId: "servierMedicalArt" }] },
  { id: "nervous", name: "Nervoso", description: "Integração sensorial, motora e autonômica.", color: "#b48a46", icon: "brain", image: "/medicine/systems/nervous-v1.png", structures: ["Encéfalo", "Medula espinal", "Nervos periféricos"], topics: ["Potencial de ação", "Sinapses", "Vias motoras e sensitivas"], atlasStructureIds: ["brain", "cerebrum", "cerebellum", "brainstem", "spinal-cord", "olfactory-nerve", "optic-nerve", "trigeminal-nerve", "facial-nerve", "vestibulocochlear-nerve", "vagus-nerve", "hypoglossal-nerve", "pudendal-nerve", "sciatic"], questionSystems: ["Nervoso"], sourceId: "openstaxCns", referenceImages: [{ image: "/medicine/references/servier/nervous-system.png", alt: "Sistema nervoso humano em vistas anterior e posterior", title: "Rede nervosa periférica", caption: "Vista corporal para relacionar encéfalo, medula e nervos periféricos.", sourceId: "servierMedicalArt" }] },
  { id: "digestive", name: "Digestório", description: "Digestão, absorção e metabolismo de nutrientes.", color: "#8d7861", icon: "activity", image: "/medicine/systems/digestive-v1.png", structures: ["Esôfago", "Estômago", "Intestinos", "Fígado", "Pâncreas"], topics: ["Motilidade", "Secreções", "Absorção"], atlasStructureIds: ["oral-cavity", "parotid-gland", "submandibular-gland", "sublingual-gland", "esophagus", "stomach", "liver", "gallbladder", "common-bile-duct", "pancreas", "duodenum", "jejunum", "ileum", "ascending-colon", "rectum", "anal-canal"], questionSystems: ["Digestório"], sourceId: "openstaxDigestive", referenceImages: [{ image: "/medicine/references/servier/digestive-apparatus.png", alt: "Aparelho digestório completo e estruturas separadas", title: "Aparelho digestório", caption: "Visão conjunta e explodida para acompanhar o trajeto e os órgãos acessórios.", sourceId: "servierMedicalArt" }] },
  { id: "musculoskeletal", name: "Musculoesquelético", description: "Sustentação, movimento e proteção.", color: "#9d685f", icon: "bone", image: "/medicine/systems/musculoskeletal-v1.png", structures: ["Ossos", "Articulações", "Músculos", "Tendões"], topics: ["Tecido ósseo", "Contração muscular", "Biomecânica"], atlasStructureIds: ["deltoid", "femur", "sphenoid-bone", "hyoid-bone", "clavicle", "scapula", "sternum", "rib-1", "humerus", "patella", "tibia", "pectoralis-major", "subscapularis", "transversus-abdominis", "piriformis", "rectus-femoris"], questionSystems: ["Musculoesquelético"], sourceId: "openstaxSkeleton", referenceImages: [{ image: "/medicine/references/servier/musculoskeletal-joints.png", alt: "Esqueleto com destaque para diferentes articulações", title: "Articulações no esqueleto", caption: "Mapa corporal que conecta ossos, articulações e regiões de movimento.", sourceId: "servierMedicalArt" }, { image: "/medicine/references/servier/muscle-microstructure.png", alt: "Organização do músculo em fascículos, fibras e miofibrilas", title: "Do músculo à miofibrila", caption: "Ampliação em níveis para relacionar anatomia macroscópica e microestrutura muscular.", sourceId: "servierMedicalArt" }] },
  { id: "endocrine", name: "Endócrino", description: "Sinalização hormonal e homeostase.", color: "#8d7397", icon: "sparkles", image: "/medicine/systems/endocrine-v1.png", structures: ["Hipófise", "Tireoide", "Suprarrenais", "Pâncreas endócrino"], topics: ["Eixos hormonais", "Retroalimentação hormonal", "Metabolismo"], atlasStructureIds: ["hypothalamus", "pituitary-gland", "pineal-gland", "thyroid-gland", "parathyroid-glands", "adrenal-glands", "pancreas"], questionSystems: ["Endócrino"], sourceId: "openstaxEndocrine", referenceImages: [{ image: "/medicine/references/servier/endocrine-pituitary.png", alt: "Hipófise e sua vascularização", title: "Hipófise e vascularização", caption: "Comparação entre a forma glandular e a rede vascular hipofisária.", sourceId: "servierMedicalArt" }] },
  { id: "urinary", name: "Urinário", description: "Filtração, equilíbrio interno e excreção.", color: "#6085a0", icon: "droplets", image: "/medicine/systems/urinary-v1.png", structures: ["Rins", "Ureteres", "Bexiga", "Uretra"], topics: ["Filtração glomerular", "Transporte tubular", "Equilíbrio ácido-base"], atlasStructureIds: ["kidneys", "ureters", "urinary-bladder", "urethra"], questionSystems: ["Urinário"], sourceId: "openstaxKidney", referenceImages: [{ image: "/medicine/references/servier/urinary-nephron.png", alt: "Néfrons no rim e detalhe vascular de um néfron", title: "Organização do néfron", caption: "Do córtex e da medula ao corpúsculo renal e à alça do néfron.", sourceId: "servierMedicalArt" }] },
  { id: "immune", name: "Linfático e imune", description: "Defesa, vigilância e retorno de fluidos.", color: "#668a75", icon: "shield", image: "/medicine/systems/immune-v1.png", structures: ["Linfonodos", "Baço", "Timo", "Vasos linfáticos"], topics: ["Imunidade inata", "Imunidade adaptativa", "Drenagem linfática"], atlasStructureIds: ["thymus", "spleen", "palatine-tonsils", "cervical-lymph-nodes", "axillary-lymph-nodes", "inguinal-lymph-nodes"], questionSystems: ["Imune", "Linfático"], sourceId: "openstaxImmune", referenceImages: [{ image: "/medicine/references/servier/immune-lymphatic.png", alt: "Linfonodos em vista externa e em corte", title: "Linfonodos e drenagem", caption: "Detalhe da chegada e saída dos vasos linfáticos e da organização interna do linfonodo.", sourceId: "servierMedicalArt" }] },
  { id: "integumentary", name: "Tegumentar", description: "Barreira corporal, anexos cutâneos e termorregulação.", color: "#c08c75", icon: "shield", image: "/medicine/systems/integumentary-v1.png", structures: ["Epiderme", "Derme", "Hipoderme", "Pelos", "Unhas", "Glândulas cutâneas"], topics: ["Barreira epidérmica", "Anexos cutâneos", "Termorregulação e sensibilidade"], atlasStructureIds: ["skin", "epidermis", "dermis", "hypodermis", "hair-follicle", "sebaceous-gland", "sweat-gland", "nails"], questionSystems: ["Tegumentar"], sourceId: "openstaxSkinLayers", referenceImages: [{ image: "/medicine/references/servier/integumentary-skin.png", alt: "Bloco tridimensional das camadas da pele e anexos", title: "Camadas e anexos da pele", caption: "Prancha em corte para localizar pelos, glândulas, vasos e receptores nas camadas cutâneas.", sourceId: "servierMedicalArt" }] },
  { id: "special-senses", name: "Sentidos especiais", description: "Visão, audição, equilíbrio, olfato e gustação.", color: "#8b79a6", icon: "eye", image: "/medicine/systems/special-senses-v1.png", structures: ["Olho", "Retina", "Orelha interna", "Epitélio olfatório", "Botões gustativos"], topics: ["Transdução sensorial", "Vias visuais e auditivas", "Equilíbrio, olfato e gustação"], atlasStructureIds: ["eyes", "cornea", "iris", "sclera", "retina", "lens-eye", "lacrimal-gland", "optic-nerve", "tympanic-membrane", "cochlea", "semicircular-canals", "olfactory-epithelium", "tongue", "taste-buds"], questionSystems: ["Sentidos especiais"], sourceId: "openstaxSenses", referenceImages: [{ image: "/medicine/references/servier/special-senses-eye.png", alt: "Olho em corte nas vistas posterior e lateral", title: "Estrutura do globo ocular", caption: "Duas vistas complementares para conferir retina, nervo óptico, cristalino e túnicas do olho.", sourceId: "servierMedicalArt" }] },
  { id: "reproductive", name: "Reprodutor", description: "Gônadas, gametas, ductos e regulação reprodutiva.", color: "#a56f86", icon: "activity", image: "/medicine/atlas/organs-anterior-v2.png", structures: ["Ovários", "Tubas uterinas", "Útero", "Testículos", "Epidídimo", "Próstata"], topics: ["Gametogênese", "Ciclos e regulação hormonal", "Trajetos reprodutivos"], atlasStructureIds: ["mammary-glands", "ovaries", "uterine-tubes", "uterus", "cervix", "vagina", "clitoris", "testes", "epididymis", "ductus-deferens", "seminal-vesicles", "bulbourethral-glands", "prostate", "scrotum"], questionSystems: ["Reprodutor"], sourceId: "openstaxReproductive", referenceImages: [{ image: "/medicine/references/servier/reproductive-apparatus.png", alt: "Aparelhos reprodutores feminino e masculino em vista frontal", title: "Aparelhos reprodutores", caption: "Comparação lado a lado de gônadas, ductos e órgãos reprodutivos internos.", sourceId: "servierMedicalArt" }] },
];
...
export const embryologyTimeline: DevelopmentStage[] = [
  ...
  },
  {
    ...
    referenceImage: {
      image: "/medicine/references/servier/development-neural-tube.png",
      alt: "Sequência de fechamento do tubo neural entre o décimo sexto e o vigésimo terceiro dia",
      title: "Fechamento do tubo neural",
      caption: "Prancha complementar para acompanhar a mudança do sulco neural até o fechamento do tubo.",
      sourceId: "servierMedicalArt",
    },
  },
  {
