...
export const anatomy3DAssets = {
  bodyBase: {
    id: "body-base",
    path: "/medicine/models/zanatomy-musculoskeletal-hd-v2.glb",
    loadMode: "base",
    sourceId: "zAnatomy3D",
    license: "CC BY-SA 4.0",
    expectedMinimumBytes: 10_800_000,
    meshCount: 960,
    triangleCount: 2_952_925,
  },
  skinBase: {
    id: "skin-base",
  ...
  cardiovascular: {
    id: "cardiovascular",
    path: "/medicine/models/zanatomy-cardiovascular-hd-v2.glb",
    loadMode: "system",
    sourceId: "zAnatomy3D",
    license: "CC BY-SA 4.0",
    expectedMinimumBytes: 4_750_000,
    meshCount: 672,
    triangleCount: 1_353_740,
  },
  nervous: {
    id: "nervous",
    path: "/medicine/models/zanatomy-nervous-hd-v2.glb",
    loadMode: "system",
    sourceId: "zAnatomy3D",
    license: "CC BY-SA 4.0",
    expectedMinimumBytes: 4_180_000,
    meshCount: 572,
    triangleCount: 1_208_218,
  },
  organs: {
    id: "organs",
    path: "/medicine/models/zanatomy-organs-hd-v2.glb",
    loadMode: "system",
    sourceId: "zAnatomy3D",
    license: "CC BY-SA 4.0",
    expectedMinimumBytes: 1_800_000,
    meshCount: 116,
    triangleCount: 706_289,
  },
  heartExterior: {
    id: "heart-exterior",
