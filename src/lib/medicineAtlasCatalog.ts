...
const surfaceStructures = makeGroup("surface", "openstaxSkin", [
  ...
  ["calcaneal-region", "Região calcânea", "calcanhar", "Referência superficial posterior do calcanhar.", posterior(61.5, 95), "Regio calcanea", ["calcanhar"], "openstaxSurfaceAnatomy"],
  ["dorsum-foot-region", "Dorso do pé", "pé", "Superfície superior do pé entre o tornozelo e os dedos.", anterior(37.5, 96), "Dorsum pedis", undefined, "openstaxSurfaceAnatomy"],
]);
...
const muscularStructures = makeGroup("muscular", "openstaxMuscle", [
  ...
  ["forearm-flexors", "Grupo flexor do antebraço", "antebraço anterior", "Flexiona punho e dedos e participa da pronação.", anterior(18.5, 43)],
  ["forearm-extensors", "Grupo extensor do antebraço", "antebraço posterior", "Estende punho e dedos e participa da supinação.", posterior(82, 42)],
  ["thenar-muscles", "Músculos tenares", "palma lateral", "Movem o polegar, incluindo oposição e abdução.", anterior(9.5, 49.5)],
  ["hypothenar-muscles", "Músculos hipotenares", "palma medial", "Movem o dedo mínimo.", anterior(13.5, 49.5)],
  ...
  ["gracilis", "Músculo grácil", "coxa medial", "Aduz a coxa e auxilia a flexão e rotação medial da perna.", anterior(44.5, 67), "Musculus gracilis"],
  ...
  ["vastus-medialis", "Vasto medial", "coxa anteromedial", "Estende o joelho e contribui para a estabilidade patelar.", anterior(42.5, 69), "Musculus vastus medialis"],
  ...
  ["semimembranosus", "Semimembranáceo", "coxa posterior medial profunda", "Estende o quadril e flexiona o joelho.", posterior(56, 67), "Musculus semimembranosus"],
  ["tibialis-anterior", "Tibial anterior", "perna anterior", "Dorsiflete e inverte o pé.", anterior(39, 83), "Musculus tibialis anterior"],
  ...
  ["gastrocnemius", "Gastrocnêmio", "panturrilha", "Realiza flexão plantar do tornozelo e auxilia a flexão do joelho.", posterior(62, 82), "Musculus gastrocnemius"],
  ...
  ["calcaneal-tendon", "Tendão calcâneo", "tornozelo posterior", "Transmite ao calcâneo a força do tríceps sural para a flexão plantar.", posterior(63, 92.5), "Tendo calcaneus", ["tendão de aquiles"]],
  ...
  ["tibialis-posterior", "Tibial posterior", "perna posterior profunda", "Realiza flexão plantar e inversão e participa da sustentação do arco medial do pé.", posterior(63, 85), "Musculus tibialis posterior"],
  ...
  ["flexor-carpi-radialis", "Flexor radial do carpo", "antebraço anterior", "Flexiona e abduz o punho.", anterior(18, 43.5), "Musculus flexor carpi radialis", undefined, "openstaxAppendicularMuscles"],
  ["flexor-carpi-ulnaris", "Flexor ulnar do carpo", "antebraço anterior medial", "Flexiona e aduz o punho.", anterior(22.5, 42.5), "Musculus flexor carpi ulnaris", undefined, "openstaxAppendicularMuscles"],
  ["extensor-digitorum", "Extensor dos dedos", "antebraço posterior", "Estende os dedos II a V e auxilia a extensão do punho.", posterior(82, 42.5), "Musculus extensor digitorum", undefined, "openstaxAppendicularMuscles"],
  ...
  ["adductor-magnus", "Adutor magno", "coxa medial profunda", "Aduz a coxa; suas porções também auxiliam flexão ou extensão do quadril.", anterior(44.5, 64), "Musculus adductor magnus", undefined, "openstaxAppendicularMuscles"],
  ...
  ["extensor-digitorum-longus", "Extensor longo dos dedos", "perna anterior", "Estende os dedos II a V e dorsiflete o tornozelo.", anterior(37, 86), "Musculus extensor digitorum longus", undefined, "openstaxAppendicularMuscles"],
  ["flexor-digitorum-longus", "Flexor longo dos dedos", "perna posterior profunda", "Flexiona os dedos laterais e auxilia flexão plantar e sustentação dos arcos.", posterior(60, 85.5), "Musculus flexor digitorum longus", undefined, "openstaxAppendicularMuscles"],
  ["extensor-hallucis-longus", "Extensor longo do hálux", "perna anterior profunda", "Estende o hálux e auxilia a dorsiflexão.", anterior(39, 87), "Musculus extensor hallucis longus", undefined, "openstaxAppendicularMuscles"],
  ["flexor-hallucis-longus", "Flexor longo do hálux", "perna posterior profunda", "Flexiona o hálux e contribui para propulsão e sustentação do arco medial.", posterior(64, 87), "Musculus flexor hallucis longus", undefined, "openstaxAppendicularMuscles"],
...
const skeletalStructures = makeGroup("skeletal", "openstaxSkeleton", [
  ...
  ["humerus", "Úmero", "braço", "Forma o esqueleto do braço e participa das articulações do ombro e cotovelo.", both(26, 31, 74, 31), "Humerus"],
  ["radius", "Rádio", "antebraço lateral", "Participa das articulações do cotovelo e punho e permite pronação e supinação.", both(19, 44, 81, 44), "Radius"],
  ["ulna", "Ulna", "antebraço medial", "Estabiliza o antebraço e forma importante articulação com o úmero.", both(22, 44, 78, 44), "Ulna"],
  ...
  ["tibia", "Tíbia", "perna medial", "Principal osso de sustentação de peso da perna.", both(42, 84, 59, 84), "Tibia"],
...
const vascularStructures = makeGroup("vascular", "openstaxCirculation", [
  ...
  ["ulnar-artery", "Artéria ulnar", "antebraço medial", "Supre o antebraço medial e participa principalmente do arco palmar superficial.", anterior(23.5, 42.5)],
  ["superficial-palmar-arch", "Arco palmar superficial", "palma", "Distribui fluxo arterial para a mão e os dedos.", anterior(11, 50.5)],
  ["deep-palmar-arch", "Arco palmar profundo", "palma profunda", "Conecta principalmente ramos radial e ulnar e contribui para a irrigação profunda da mão.", anterior(11.5, 50), "Arcus palmaris profundus"],
  ...
  ["anterior-tibial-artery", "Artéria tibial anterior", "perna anterior", "Supre o compartimento anterior da perna e continua-se no dorso do pé.", anterior(39.5, 83)],
  ["posterior-tibial-artery", "Artéria tibial posterior", "perna posterior", "Supre compartimentos posteriores e planta do pé.", posterior(60.5, 83)],
  ...
  ["plantar-arterial-arch", "Arco arterial plantar", "planta do pé", "Distribui fluxo para metatarsos e dedos e conecta ramos plantares.", posterior(62.5, 96), "Arcus plantaris"],
  ...
  ["ulnar-veins", "Veias ulnares", "antebraço medial profundo", "Acompanham a artéria ulnar e participam da drenagem profunda do antebraço.", anterior(22.5, 42), "Venae ulnares"],
  ...
  ["basilic-vein", "Veia basílica", "membro superior medial", "Drena superficialmente o lado medial do membro superior.", anterior(27.5, 35)],
  ...
  ["anterior-tibial-veins", "Veias tibiais anteriores", "perna anterior profunda", "Drenam o compartimento anterior da perna.", anterior(40.5, 83), "Venae tibiales anteriores"],
  ["posterior-tibial-veins", "Veias tibiais posteriores", "perna posterior profunda", "Drenam a planta e o compartimento posterior da perna.", posterior(61.5, 83), "Venae tibiales posteriores"],
  ["great-saphenous-vein", "Veia safena magna", "membro inferior medial", "Drena superficialmente o membro inferior e desemboca na veia femoral.", anterior(43.5, 78)],
...
const nervousStructures = makeGroup("nervous", "openstaxPns", [
  ...
  ["ulnar-nerve", "Nervo ulnar", "membro superior medial", "Inerva diversos músculos da mão e parte dos flexores do antebraço.", anterior(27.5, 39), "Nervus ulnaris"],
  ...
  ["saphenous-nerve", "Nervo safeno", "perna medial", "Ramo sensitivo do femoral para a face medial da perna e do pé.", anterior(42.5, 82), "Nervus saphenus"],
  ...
  ["medial-plantar-nerve", "Nervo plantar medial", "planta do pé", "Inerva músculos e pele da porção medial da planta.", posterior(61, 96), "Nervus plantaris medialis"],
...
const organStructures = makeGroup("organs", "openstax", [
  ...
  ["vagina", "Vagina", "pelve e períneo", "Canal fibromuscular que se estende do colo do útero ao vestíbulo.", anterior(50, 52.5), "Vagina", undefined, "openstaxReproductive"],
  ["vulva", "Vulva", "períneo anterior", "Conjunto das estruturas genitais externas típicas da anatomia ovariana.", anterior(50, 54.2), "Pudendum femininum", undefined, "openstaxReproductive"],
  ["clitoris", "Clitóris", "vulva", "Órgão erétil altamente inervado relacionado à resposta sexual.", anterior(50, 53.5), "Clitoris", undefined, "openstaxReproductive"],
