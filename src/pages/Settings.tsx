...
import { Sun, Moon, CircleDot, LogOut, ArrowLeft, Shield, User, Target, Sparkles, Bell, BellOff, Loader2, Save, LayoutDashboard, Calendar } from "lucide-react";
    ...
    <div className="min-h-screen bg-background pb-20 md:pb-6">
      ...
      <main className="container max-w-2xl mx-auto px-3 sm:px-4 py-6 space-y-6">
        ...
        <section className="rounded-2xl border border-border bg-card p-4 sm:p-5 space-y-3">
          ...
          <p className="text-sm text-muted-foreground">
            Escolha quais seções aparecem no seu dashboard e em qual ordem.
          </p>
          <DashboardCustomizer />
        </section>
        ...
        <section className="rounded-2xl border border-border bg-card p-4 sm:p-5 space-y-3">
          ...
          <p className="text-sm text-muted-foreground">
            Exporte seu cronograma de estudos para o Google Calendar, Outlook ou qualquer app de calendário.
          </p>
          <CalendarIntegration />
        </section>
